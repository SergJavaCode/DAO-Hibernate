package ru.sergjava.daohibernate;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().requestMatchers("/persons/find-by-name-surname").hasRole("ADMIN")
                ...
                .requestMatchers("/persons/find-by-city").authenticated().and().formLogin();
        return http.build();
    }
